...
const MODEL_USER_BADGE = 'UserBadge';
...
const ACTION_ADMIN_HOME_NOTICE_UPDATE = 'ADMIN_HOME_NOTICE_UPDATE';
const ACTION_ADMIN_HOME_WIDGETS_UPDATE = 'ADMIN_HOME_WIDGETS_UPDATE';
...
// User Badge actions
const ACTION_USER_BADGE_GRANT = 'USER_BADGE_GRANT';
const ACTION_ADMIN_BADGE_TYPE_CREATE = 'ADMIN_BADGE_TYPE_CREATE';
const ACTION_ADMIN_BADGE_TYPE_UPDATE = 'ADMIN_BADGE_TYPE_UPDATE';
const ACTION_ADMIN_BADGE_TYPE_DELETE = 'ADMIN_BADGE_TYPE_DELETE';
...
export const SupportedAction = {
  ...
  ACTION_ADMIN_HOME_NOTICE_UPDATE,
  ACTION_ADMIN_HOME_WIDGETS_UPDATE,
  ...
  ACTION_AUDIT_LOG_BULK_EXPORT_NO_RESULTS,
  // User Badge actions
  ACTION_USER_BADGE_GRANT,
  ACTION_ADMIN_BADGE_TYPE_CREATE,
  ACTION_ADMIN_BADGE_TYPE_UPDATE,
  ACTION_ADMIN_BADGE_TYPE_DELETE,
  // GROWI Vault actions
